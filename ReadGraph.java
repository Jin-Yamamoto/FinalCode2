...
public class ReadGraph {
    ...
    public static void main(String args[]) {
        ...
        for(int i = 0; i < connectedVertices.length; i++){
            ...
            // put i into variable to pass the value to the method "getColorNumber"
            int currentBaseNumber = i;

            // The if statement below saying that color by the color1, if the vertix does not have any color. 
            if(i > 0){
                colorNumber[i] = 1;
            }
